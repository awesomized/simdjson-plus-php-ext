--TEST--
Test simdjson_encode() function : basic functionality
--FILE--
<?php
echo "*** Testing simdjson_encode() : basic functionality ***\n";
...
foreach($inputs as $input) {
    ...
    try {
        var_dump(simdjson_encode($input));
    } catch (Exception $e) {
        var_dump(false);
    }
    $count ++;
...
?>
--EXPECT--
*** Testing simdjson_encode() : basic functionality ***
-- Iteration 1 --
string(1) "0"
-- Iteration 2 --
string(3) "123"
